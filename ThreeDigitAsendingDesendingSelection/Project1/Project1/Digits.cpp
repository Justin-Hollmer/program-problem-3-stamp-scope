...
for (int x = 0; x < 30; x++){
	...
	var3 = (calc_1 / 100) % 100; // Digit in the hundreds place
			...
			{cout << calc_1 << " is ascending " << endl;} // Will print out ascending
			else if (var3 > var2 && var2 > var1) 
			{cout << calc_1 << " is descending " << endl;} // Will print out descending
			else {cout << "neither " << endl;} // Will print out neither
